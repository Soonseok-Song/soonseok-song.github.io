...
**파일명을 알아보게 지으면 그대로 설명이 됩니다.** 하이픈·언더스코어는 공백이 되고 첫 글자가 대문자가 됩니다.

```
towing-tank-test.jpg                →  "Towing tank test"
2026-07-27-towing-tank-test.jpg     →  "Towing tank test"     맨 앞 날짜는 떼어냅니다
ISOPE-2026-Seoul.jpg                →  "ISOPE 2026 Seoul"     연도는 남깁니다
lab_dinner_2026.jpg                 →  "Lab dinner 2026"
...
> **파일명 맨 앞을 날짜로 시작하면** 갤러리에서 최신 사진이 앞에 옵니다. 설명에는 날짜가 안 들어가니 `2026-07-27-towing-tank-test.jpg` 형태가 가장 좋습니다.
