...
**확장자만 떼고 파일명을 그대로 씁니다.** 손대지 않으니 지으신 대로 나옵니다.

```
Visit to Durham 2026 July (1 of 2).jpg  →  "Visit to Durham 2026 July (1 of 2)"
2026 KAOSTS 공동학술대회 ICC Jeju 2026 May.jpg
                                        →  그대로 (한글도 됩니다)
```

**정렬은 파일명 안의 연월을 읽어 최신순으로 합니다.** 어디에 있어도 찾습니다:

```
Visit to Newcastle 2026 July.jpg     →  2026-07
OMAE 2026 Tokyo 2026 June.jpg        →  2026-06   (뒤쪽 연월을 씁니다)
2026-07-27-towing-tank-test.jpg      →  2026-07   (이 형식도 됩니다)
```

연월이 없으면 맨 뒤로 갑니다.

**같은 행사 사진이 여러 장이면** `(1 of 2)`, `(2 of 2)` 를 붙이세요. 번호 순으로 나옵니다. (파일명에는 `/` 를 쓸 수 없어 `of` 를 씁니다.)
